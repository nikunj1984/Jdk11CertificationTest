...
// static block is not called when accessing final static field
class StaticStuff {
...
//        // We access static member of the StaticStuff class
        System.out.println("Application Name: " + s11.appName);//no null pointer here as we are accessing static fielf
//
